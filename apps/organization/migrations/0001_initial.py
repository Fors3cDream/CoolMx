    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('pxjg', '培训机构'), ('gx', '高校'), ('gr', '个人')], default='pxjg', max_length=4, verbose_name='机构类别')),
                ('tag', models.CharField(default='优质培训机构', max_length=10, verbose_name='机构标签')),
