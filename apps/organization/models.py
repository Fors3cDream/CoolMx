...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=4,choices=ORG_CHOICES, verbose_name="机构类别", default="pxjg")
    tag = models.CharField(max_length=10, default="优质培训机构", verbose_name="机构标签")
    ...
    course_nums = models.IntegerField(default=0, verbose_name="发布课程数")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
...
class Teacher(models.Model):
    ...
    age = models.IntegerField(default=22, verbose_name="年龄")
